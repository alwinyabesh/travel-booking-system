...
<body>
            ...
            <section class="home" id="home">
                ...
                <div class="home__container container grid">
                    <div class="home__data">
                        ...
                        <h1 class="home__data-title">Explore The <br> Best <b>Beautiful <br> Tourist Places</b></h1>
                        <a href="GlobeTrekker.aspx" class="button">Explore</a>
                    ...
                    <div class="home__info">
                        <div>
                            ...
                            <a href="more.aspx" class="button button--flex button--link home__info-button">
            ...
            <section class="about section" id="about">
                <div class="about__container container grid">
                    <div class="about__data">
                        <h2 class="section__title about__title">More Information <br> About The GlobeTrekker</h2>
    ...
    <div class="subscribe__bg">
        <div class="subscribe__container container">
            <h2 class="section__title subscribe__title">Stay Connected, Get Rewarded!</h2>
            <p class="subscribe__description">Unlock exclusive deals and stay updated with our latest offerings. Sign up for our newsletter now and enjoy an instant 30% discount on your next purchase.</p>
            ...
            <div class="footer__container container grid">
                <div class="footer__content grid">
                    ...
                    <div class="footer__data">
                        ...
                        <ul>
                            <li class="footer__item">
                                <a href="about.aspx" class="footer__link">About Us</a>
                            </li>
                            <li class="footer__item">
                    ...
                    <div class="footer__data">
                        ...
                        <ul>
                            <li class="footer__item">
                                <a href="team.aspx" class="footer__link">Team</a>
                            </li>
                            <li class="footer__item">
                                <a href="" class="footer__link"></a>
                            </li>
                            <li class="footer__item">
                                <a href="more.aspx" class="footer__link">Become a member</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="footer__data">
                        ...
                        <ul>
                            <li class="footer__item">
                                <a href="more.aspx" class="footer__link">FAQs</a>
                            </li>
                            <li class="footer__item">
                                <a href="" class="footer__link"></a>
                            </li>
                            <li class="footer__item">
                                <a href="more.aspx" class="footer__link">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="footer__rights">
                    <p class="footer__copy">&#169; 2024 alwin yabesh. All rigths reserved.</p>
